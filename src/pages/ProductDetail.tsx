...
const ProductDetail = () => {
  ...
  }, [selectedCubeSize, selectedQuantity]);
                  ...
                  <div className="block mt-6">
                    <div className="flex items-center gap-2 font-bold">
                      ...
                      {product.discountPrice && (
                        <span className="text-[#C72C41] text-xl font-bold leading-7">
                          <strike>₹{product.price}/-</strike>
                        </span>
                      )}
                      {product.discountPrice && (
                        <div className="bg-[#E3A914] text-white text-xs font-bold leading-4 px-4 py-1 relative">
                          <span>
                            {Math.round(
